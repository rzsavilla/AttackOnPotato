	...
	if (bCanFire == true)
	{
		...
		if (FireDirection.SizeSquared() > 0.0f)
		{
			...
			if (World != NULL)
			{
				...
				World->SpawnActor<AAttackOnPotatoProjectile>(SpawnLocation, FireRotation);
			}

			bCanFire = false;
			World->GetTimerManager().SetTimer(TimerHandle_ShotTimerExpired, this, &AAttackOnPotatoPawn::ShotTimerExpired, FireRate);
